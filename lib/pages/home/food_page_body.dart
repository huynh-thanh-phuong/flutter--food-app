    ...
    return Column(
      children: [
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts){
          return popularProducts.isLoader ?
          SizedBox(
            ...
            child: PageView.builder(
                ...
                itemBuilder: (context, position){
                  var item = popularProducts.popularProductList[position];
        ...
        GetBuilder<PopularProductController>(builder: (popularProducts){
          return DotsIndicator(
            ...
            // .round() làm tròn lên số thực vd: 0.5 -> 1
        ...
        GetBuilder<RecommendedProductController>(builder: (recommendedProduct){
          return recommendedProduct.isLoader
              ...
              itemBuilder: (context, index){
                var item = recommendedProduct.recommendedProductList[index];
